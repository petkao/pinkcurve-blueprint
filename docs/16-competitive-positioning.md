...
This document analyzes PinkCurve's competitive landscape and positioning. Understanding where we fit—and where we differ—helps clarify our strategy and communicate our value.
...
| Aspect | Their Approach | PinkCurve Difference |
|--------|---------------|---------------------|
| Transaction | Process on platform | Click-through to seller site |
| Fees | Transaction-based | Discovery-based |
| Relationship | Marketplace owns customer | Seller owns customer |
| Data | Platform keeps most data | Intelligence flows to sellers |

**Our positioning:** We help sellers reach buyers who will purchase on their own sites.

### Category: Video Creation

**Examples:** Canva, Lumen5, Synthesia

| Aspect | Their Approach | PinkCurve Difference |
|--------|---------------|---------------------|
| Focus | Content creation tool | Discovery platform with creative |
| Discovery | Not included | Core capability |
| Learning | None | Continuous improvement |
| Integration | Standalone | End-to-end platform |
...
**Our positioning:** AI-powered discovery that scales, with seller intelligence.
...
|------|-------------|------------|
| **Big platform entry** | Amazon, Google build similar | Move fast, build moat |
...
- Evaluate relevance to our strategy
- Consider adaptation if aligned
- Maintain focus on our differentiation
...
**Important note:** This positioning represents our aspiration. We are building toward this vision but have not yet validated all claims.

| Claim | Status |
|-------|--------|
| AI-powered matching | Building (embeddings planned) |
| Better than ad targeting | Hypothesis (unvalidated) |
| Learning improves over time | Hypothesis (unvalidated) |
| Sellers see better ROI | Hypothesis (unvalidated) |
