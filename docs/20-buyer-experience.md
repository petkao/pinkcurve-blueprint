...
PinkCurve may use rich offering knowledge, metadata, buyer interaction signals, location relevance, contextual information, ranking models, learning systems, and trust signals to determine which offerings to retrieve and how to organize them.
...
See [Offering Knowledge](04-offering-knowledge.md), [Discovery Engine](06-discovery-engine.md), and [Learning Engine](08-learning-engine.md).
